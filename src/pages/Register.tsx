...
제2조 (정의)
① "서비스"란 아트패스가 운영하는 비공식 디자인 입시 정보 웹사이트를 의미합니다.
...
const PRIVACY_CONTENT = `아트패스(이하 "서비스")는 개인정보 보호법 제30조에 따라 이용자의 개인정보를 보호하고 관련 고충을 신속하게 처리하기 위하여 다음과 같이 개인정보 처리방침을 수립·공개합니다.
